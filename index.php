...
$cliente = array(
    0 => new Cliente('Clayton Lima','111111111111','30','M','Rua perdida SP','PJ'),
    1 => new Cliente('Carol Lima','22222222222','45','F','Rua achei SP','PF'),
    2 => new Cliente('Geo Lima','33333333','55','F','Rua perdida SP','PJ'),
    3 => new Cliente('Bruno Lima','44444444','18','M','Rua perdida SP','PF'),
    4 => new Cliente('Lucas Lima','5555555555','14','M','Rua perdida SP','PF'),
    5 => new Cliente('Luan Lima','6666666','30','M','Rua perdida SP','PJ'),
    6 => new Cliente('Fernando Lima','9999999','25','M','Rua perdida SP','PF'),
    7 => new Cliente('Rodrigo Lima','4101010101','20','M','Rua perdida SP','PJ'),
    8 => new Cliente('Paula Lima','121212121212','28','M','Rua perdida SP','PJ'),
    9 => new Cliente('Eduardo Lima','131313131331','55','M','Rua perdida SP','PF')
);
...
<div class="form-group" style="width: 500px; margin:0 auto; margin-top: 10px;">
    <form action="index.php" method="GET">
     ...
     <div>
         <fieldset>
             <input type="radio" name="ordenar" value="0">Pessoa Física<br>
             <input type="radio" name="ordenar" value="1" style="margin-bottom: 10px;">Pessoa Jurídica<br>
         </fieldset>
     </div>
